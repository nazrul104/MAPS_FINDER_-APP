<!-- Content -->
<div style="font-size:15px; color: #999999; padding-bottom: 15px; float:left;">Times Open and Close | <span id="images-location-name"></span></div>
...
<div class="mainview view">
	<div id="form" style="display:none; padding-bottom:45px;">
		<form method="post" id="submit-form" action="times/insert">
	...
	<div class="innert-list">
    		<h1>Day</h1>
    		<div class="corner">
				<select name="times_day" id="times_day">
		...
		<div class="innert-list">
    		<h1>Open</h1>
    		<div class="corner">
    			<input type="text" name="times_open" id="times_open" style="width: 80px;" placeholder="08:00">
			</div>
    	</div>
		<div class="innert-list">
    		<h1>Close</h1>
    		<div class="corner">
				<input type="text" name="times_close" id="times_close" style="width: 80px;" placeholder="20:30">
    		</div>
    	</div>
		<div class="innert-list">
    	<br />
...
$(document).ready(function() {
	...
	$('#tabels tbody').on('click','tr', function () {
	 ...
	 if(aData != null){
	 	...
	 	$('#times_id').val(aData[3]);
		$('#remove_times_id').val(aData[3]);
		//$('#times_day').val(aData[0]);
		$('#times_day > option[value="'+aData[4]+'"]').prop("selected", "selected");
		$('#times_open').val(aData[1]);
	 	$('#times_close').val(aData[2]);
		$('#times_markers_id').val(timesMarkerId);
